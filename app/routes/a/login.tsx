      ...
      <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        ...
        <form className="max-w-lg border rounded-lg mx-auto">
          <div className="flex flex-col gap-4 p-4 md:p-8">
            ...
            <div>
              <a href="/a/forgot-password" className="float-right font-semibold hover:underline hover:text-blue-500">Forgot password?</a>
            </div>
          ...
          <div className="flex justify-center items-center bg-gray-100 p-4">
            <p className="text-gray-500 text-sm text-center">
              Don't have an account? <a href="/a/register" className="hover:underline hover:text-indigo-600 active:text-indigo-700 transition duration-100">Register</a>
            </p>
          </div>
        </form>
      </div>
